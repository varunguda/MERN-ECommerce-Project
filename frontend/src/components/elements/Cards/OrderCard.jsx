                    ...
                    <div key={ind} className="order-item">
                        ...
                        <Link to={`/product/${item.product}`} className="order-product link" target='_blank'>
                            <div className="order-image-container">
                                <img src={item.product_img ? item.product_img : "https://images.unsplash.com/photo-1571782742478-0816a4773a10?q=80&w=1901&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"} alt="order-img" />
                            </div>
